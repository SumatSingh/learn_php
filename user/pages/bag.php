...
<body>
 ...
 <div class="container my-5">
    <div class="row text-center">
      <div class="col-3">
        <a href="home.php" class="btn btn-success w-100 py-3 text-white">
          <i class="fas fa-home"></i> All
        </a>
      </div>
      <div class="col-3">
        <a href="" class="btn btn-primary w-100 py-3 text-white">
      ...
      <div class="col-3">
        <a href="bag.php" class="btn btn-warning w-100 py-3 text-white">
